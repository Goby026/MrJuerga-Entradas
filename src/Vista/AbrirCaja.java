...
public class AbrirCaja extends javax.swing.JFrame {
    ...
    public void datosIniciales(String usuario) throws Exception {
        ...
        OpcionPrecios.addWindowFocusListener(new WindowFocusListener() {
            @Override
            ...
            public void windowLostFocus(WindowEvent e) {
                OpcionPrecios.setVisible(false);
            }
        });
    ...
    private void initComponents() {
        ...
        OpcionPrecios = new javax.swing.JDialog();
        btnEntradaVip = new javax.swing.JButton();
        btnEntradaGeneral = new javax.swing.JButton();
        btnCancelarConfPrecios = new javax.swing.JButton();
        ...
        OpcionPrecios.getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        btnEntradaVip.setBackground(new java.awt.Color(102, 102, 102));
        btnEntradaVip.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
        btnEntradaVip.setForeground(new java.awt.Color(255, 255, 255));
        btnEntradaVip.setText("ENTRADA VIP");
        btnEntradaVip.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnEntradaVipActionPerformed(evt);
            }
        });
        OpcionPrecios.getContentPane().add(btnEntradaVip, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, 290, 80));

        btnEntradaGeneral.setBackground(new java.awt.Color(255, 153, 102));
        btnEntradaGeneral.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
        btnEntradaGeneral.setForeground(new java.awt.Color(255, 255, 255));
        btnEntradaGeneral.setText("ENTRADA GENERAL");
        btnEntradaGeneral.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnEntradaGeneralActionPerformed(evt);
            }
        });
        OpcionPrecios.getContentPane().add(btnEntradaGeneral, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 290, 80));

        btnCancelarConfPrecios.setBackground(new java.awt.Color(255, 0, 0));
        btnCancelarConfPrecios.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        btnCancelarConfPrecios.setForeground(new java.awt.Color(255, 255, 255));
        btnCancelarConfPrecios.setText("CANCELAR");
        btnCancelarConfPrecios.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCancelarConfPreciosActionPerformed(evt);
            }
        });
        OpcionPrecios.getContentPane().add(btnCancelarConfPrecios, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 220, 290, 40));
        ...
        getContentPane().add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 310, -1, -1));
        ...
        getContentPane().add(btnAperturar, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 670, 230, 50));
        ...
        getContentPane().add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 720, 230, -1));
        ...
        btnPrecios.setBackground(new java.awt.Color(51, 102, 255));
        btnPrecios.setFont(new java.awt.Font("Tahoma", 0, 20)); // NOI18N
        ...
        jPanel9.add(btnPrecios, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 170, -1));

        getContentPane().add(jPanel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 760, 640, 80));
    ...
    private void btnPreciosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPreciosActionPerformed
        OpcionPrecios.setVisible(true);
        OpcionPrecios.setBounds(600, 300, 320, 300);
    ...
    private void btnEntradaGeneralActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntradaGeneralActionPerformed
        try {
            ConfigPrecioGeneral cpg = new ConfigPrecioGeneral();
            cpg.setVisible(true);
            btnCancelarConfPrecios.doClick();
            dispose();
        } catch (Exception ex) {
    ...
    private void btnCancelarConfPreciosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarConfPreciosActionPerformed
        OpcionPrecios.dispose();
    }//GEN-LAST:event_btnCancelarConfPreciosActionPerformed

    private void btnEntradaVipActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntradaVipActionPerformed
        try {
            ConfigPrecioVip cpg = new ConfigPrecioVip();
            cpg.setVisible(true);
            btnCancelarConfPrecios.doClick();
            dispose();
        } catch (Exception ex) {
    ...
    private javax.swing.JDialog OpcionPrecios;
    private javax.swing.JButton btnAperturar;
    private javax.swing.JButton btnCancelar;
    private javax.swing.JButton btnCancelarConfPrecios;
